...
export default class AjcForm3 extends Component<{}> {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <SafeAreaView>
                ...
                <ScrollView
                    ...
                    <AwesomeAlert
                        ...
                        showProgress={false}
                        title="Success!"
                        message="AJC (Assessor Judgement Coversheet) has been successfully saved."
...
<AwesomeAlert
                        ...
                        showProgress={false}
                        title="Success!"
                        message="AJC (Assessor Judgement Coversheet) has been successfully completed."
                        closeOnTouchOutside={false}
                        closeOnHardwareBackPress={false}
                        showCancelButton={false}
                        showConfirmButton={true}
                    ...
                    <View style={styles.unitArea}>
                        ...
                        <Row style={styles.firstRow}>
                            ...
                            <Col style={styles.unit1}>
                                ...
                                UNIT : AMPX208 Apply environmentally sustainable work practices
                                </Text>
                    ...
                    <View style={styles.supervisorArea}>
                        ...
                        <Row style={{ width: '100%', height: '100%'}}>
                            ...
                            <Col style={styles.actualSignatureArea}>
                                <Row style={{ height: '25%' }}>
                                    <Text style={{ color: '#000000', fontSize: 26, fontWeight: '500', fontFamily: 'Helvetica Neue', paddingTop: 35 }}>
                                        Student Signature:
                                  </Text>
                                </Row>

                                <Row style={{ height: '75%', width: '100%', borderColor: '#919090', borderWidth: 2 }}>

...
export default class SaForm2 extends Component<{}> {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <Row style={{ height: '100%' }}>
                            ...
                            <View style={styles.tableCls}>
                                ...
                                <View>
                                    ...
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 20, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 28, paddingLeft: 5 }}>explain employee’s responsibilities </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>explain the flow of product from receival to sale in own workplace </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>follow relevant workplace policies </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>identify relevant workplace requirements, policies and procedures and explain their implications for trainees </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>list the markets where the company’s products are distributed</Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>name the products produced in own workplace </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>outline the path of meat from paddock to plate </Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>relate to others in an effective and non-discriminatory way showing mutual respect</Text>
                                    </Unorderedlist>
                                    <Unorderedlist bulletUnicode={0x2022} style={{ fontSize: 30, paddingTop: 0, paddingLeft: 100 }}><Text style={{ fontSize: 18, paddingTop: 8, paddingLeft: 5 }}>use relevant communication skills </Text>
                                    </Unorderedlist>

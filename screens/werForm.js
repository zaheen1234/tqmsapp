...
export default class WerForm extends Component<{}> {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <ScrollView
                    ...
                    <View style={styles.questionsArea}>
                        <Row style={styles.questionHeader}>
                            <Col style={styles.headerCol1}>
                                <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center', fontSize: 24, paddingTop: 12 }}>
                                    Observe
                            </Text>
                            </Col>

                            <Col style={styles.headerCol2}>
                                <Text style={{ color: 'white', fontWeight: 'bold', paddingLeft: 15, fontSize: 24, paddingTop: 12 }}>
                                    Skills & Knowledge Requirement
                            </Text>
                            </Col>

                            <Col style={styles.headerCol3}>
                                <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center', fontSize: 24, paddingTop: 12 }}>
                                    Previous
                            </Text>
                            </Col>

                            <Col style={styles.headerCol4}>
                                <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center', fontSize: 24, paddingTop: 12 }}>
                                    S
                            </Text>
                            </Col>
                        ...
                        <Row style={styles.questionRow}>
                            <Col style={styles.headerCol11}>
                                <Text style={styles.indexCls}>
                                    S-Ob. 1
                            </Text>
                            </Col>

                            <Col style={styles.headerCol21}>
                            <Text style={styles.questionCls}>
                                    Does the student demonstrate the ability to exchange relevant routine information with others to:
                            </Text>
                            </Col>

                            <Col style={styles.headerCol31}>
...
const styles = StyleSheet.create({
    ...
    indexCls: { fontFamily: 'Helvetica Neue',
    color: '#333333', textAlign: 'center', fontSize: 22, paddingTop: 20 },

    questionCls:  { paddingLeft: 30, fontSize: 22, paddingTop: 20, fontFamily: 'Helvetica Neue',
    color: '#333333', },
